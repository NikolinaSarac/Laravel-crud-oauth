...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                    <ul id="tocify-header-birt-rest-api-projekt" class="tocify-header">
                <li class="tocify-item level-1" data-unique="birt-rest-api-projekt">
                    <a href="#birt-rest-api-projekt">BIRT REST API projekt</a>
                </li>
                                    <ul id="tocify-subheader-birt-rest-api-projekt" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="tehnologije">
                                <a href="#tehnologije">Tehnologije</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="opis-sustava">
                                <a href="#opis-sustava">Opis sustava</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="demo-pristup">
                                <a href="#demo-pristup">Demo pristup</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-http-basic-authentication-upute-za-koristenje" class="tocify-header">
                <li class="tocify-item level-1" data-unique="http-basic-authentication-upute-za-koristenje">
                    <a href="#http-basic-authentication-upute-za-koristenje">HTTP Basic Authentication - Upute za korištenje</a>
                </li>
                                    <ul id="tocify-subheader-http-basic-authentication-upute-za-koristenje" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="testni-korisnicki-racun">
                                <a href="#testni-korisnicki-racun">Testni korisnički račun</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="koristenje-u-postman-u">
                                <a href="#koristenje-u-postman-u">Korištenje u Postman-u</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="napomena">
                                <a href="#napomena">Napomena</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="categories">
                    <a href="#categories">Categories</a>
                                ...
                                <a href="#categories-GETapi-categories">Prikaz svih kategorija

Dohvaća listu svih kategorija.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-POSTapi-categories">
                                <a href="#categories-POSTapi-categories">Dodavanje nove kategorije

Kreira novu kategoriju sa nazivom i opcionalnim opisom.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-GETapi-categories--id-">
                                <a href="#categories-GETapi-categories--id-">Prikaz pojedine kategorije

Prikazuje detalje jedne kategorije po ID-u.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-PUTapi-categories--id-">
                                <a href="#categories-PUTapi-categories--id-">Ažuriranje kategorije

Ažurira postojeću kategoriju po ID-u.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="categories-DELETEapi-categories--id-">
                                <a href="#categories-DELETEapi-categories--id-">Brisanje kategorije

Briše kategoriju po ID-u.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="customers">
                    <a href="#customers">Customers</a>
                                ...
                                <a href="#customers-GETapi-customers">Prikaz svih kupaca

Dohvaća listu svih kupaca iz baze.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-POSTapi-customers">
                                <a href="#customers-POSTapi-customers">Kreiranje novog kupca

Kreira novog kupca sa svim obaveznim podacima.
Automatski generira jedinstveni customerNumber (max + 1 ili 1000 ako nema kupaca).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-GETapi-customers--id-">
                                <a href="#customers-GETapi-customers--id-">Prikaz pojedinog kupca

Dohvaća detalje kupca prema ID-u (customerNumber).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-PUTapi-customers--id-">
                                <a href="#customers-PUTapi-customers--id-">Ažuriranje kupca

Ažurira postojeće podatke kupca prema ID-u. Nisu svi podaci obavezni prilikom ažuriranja.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="customers-DELETEapi-customers--id-">
                                <a href="#customers-DELETEapi-customers--id-">Brisanje kupca

Briše kupca iz baze prema ID-u.</a>
                            </li>
                                                                        </ul>
                            </ul>
...
Vraća JSON listu svih proizvoda iz baze.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-POSTapi-products">
                                <a href="#products-POSTapi-products">Spremi novi proizvod

Kreira novi proizvod sa zadanim podacima.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-GETapi-products--id-">
                                <a href="#products-GETapi-products--id-">Prikaži proizvod po ID-u

Dohvaća detalje proizvoda prema ID-u.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-PUTapi-products--id-">
                                <a href="#products-PUTapi-products--id-">Ažuriraj proizvod

Ažurira podatke proizvoda prema ID-u. Podaci nisu svi obavezni.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-DELETEapi-products--id-">
                                <a href="#products-DELETEapi-products--id-">Obriši proizvod

Briše proizvod iz baze prema ID-u.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="page-wrapper">
    ...
    <div class="content">
        <h1 id="birt-rest-api-projekt">BIRT REST API projekt</h1>
<p>Ova aplikacija predstavlja RESTful web servis razvijen u Laravel PHP frameworku, kao dio zadatka za predmet Arhitektura aplikacija.</p>
<h2 id="tehnologije">Tehnologije</h2>
<ul>
<li>Backend: Laravel 10</li>
<li>Baza podataka: MySQL</li>
<li>Autentifikacija: HTTP Basic Auth</li>
<li>Alat za testiranje API-ja: Postman</li>
<li>Verzija PHP-a: 8.2</li>
</ul>
<h2 id="opis-sustava">Opis sustava</h2>
<p>Sustav omogućuje CRUD operacije nad entitetima (npr. Customers), uz implementiranu zaštitu API endpointa pomoću HTTP Basic Auth.</p>
<h2 id="demo-pristup">Demo pristup</h2>
<ul>
<li>Email: test@test.com</li>
<li>Lozinka: tajna123</li>
</ul>
<p>Upute za testiranje API-ja se nalaze u <code>auth.md</code> datoteci.</p>

        <h1 id="http-basic-authentication-upute-za-koristenje">HTTP Basic Authentication - Upute za korištenje</h1>
<p>Za pristup REST API endpointima, implementirana je zaštita putem HTTP Basic Auth.</p>
<h2 id="testni-korisnicki-racun">Testni korisnički račun</h2>
<ul>
<li><strong>Email:</strong> test@test.com</li>
<li><strong>Lozinka:</strong> tajna123</li>
</ul>
<h2 id="koristenje-u-postman-u">Korištenje u Postman-u</h2>
<ol>
<li>Otvorite Postman.</li>
<li>Odaberite HTTP metodu (GET, POST, PUT, DELETE).</li>
<li>Upišite URL API rute, npr.:<br />
<code>http://localhost:8000/api/customers</code></li>
<li>Idite na tab <strong>Authorization</strong>.</li>
<li>Izaberite <strong>Basic Auth</strong> kao tip autorizacije.</li>
<li>U polja upišite:
<ul>
<li><strong>Username:</strong> <code>test@test.com</code></li>
<li><strong>Password:</strong> <code>tajna123</code></li>
</ul></li>
<li>Kliknite <strong>Send</strong>.</li>
</ol>
<p>Ako su podaci ispravni, API će dopustiti pristup i vratiti JSON odgovor.
U suprotnom, vraća se status <code>401 Unauthorized</code>.</p>
<hr />
<h2 id="napomena">Napomena</h2>
<ul>
<li>Basic Auth koristi email kao korisničko ime, a lozinku koju ste unijeli prilikom registracije.</li>
<li>Ova metoda koristi se samo za demo/testiranje i nije preporučena za produkcijsko okruženje bez dodatne HTTPS zaštite.</li>
</ul>
        ...
        <h1 id="categories">Categories</h1>
                                ...
                                <h2 id="categories-GETapi-categories">Prikaz svih kategorija

Dohvaća listu svih kategorija.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="categories-POSTapi-categories">Dodavanje nove kategorije

Kreira novu kategoriju sa nazivom i opcionalnim opisom.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Naziv kategorije. Maksimalno 255 znakova. Example: <code>"Elektronika"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               value=""Sve o elektronici""
               data-component="body">
    <br>
<p>Opis kategorije. Example: <code>"Sve o elektronici"</code></p>
        </div>
        </form>

                    <h2 id="categories-GETapi-categories--id-">Prikaz pojedine kategorije

Prikazuje detalje jedne kategorije po ID-u.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID kategorije. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="categories-PUTapi-categories--id-">Ažuriranje kategorije

Ažurira postojeću kategoriju po ID-u.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Novi naziv kategorije. Maksimalno 255 znakova. Example: <code>"Gadgeti"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string|null</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               value=""Sve o gadgetima""
               data-component="body">
    <br>
<p>Novi opis kategorije. Example: <code>"Sve o gadgetima"</code></p>
        </div>
        </form>

                    <h2 id="categories-DELETEapi-categories--id-">Brisanje kategorije

Briše kategoriju po ID-u.</h2>
...
<p>ID kategorije. Example: <code>1</code></p>
                ...
                <h1 id="customers">Customers</h1>
                                ...
                                <h2 id="customers-GETapi-customers">Prikaz svih kupaca

Dohvaća listu svih kupaca iz baze.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="customers-POSTapi-customers">Kreiranje novog kupca

Kreira novog kupca sa svim obaveznim podacima.
Automatski generira jedinstveni customerNumber (max + 1 ili 1000 ako nema kupaca).</h2>
...
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>customerName</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="customerName"                data-endpoint="POSTapi-customers"
               value=""ACME Corp""
               data-component="body">
    <br>
<p>Ime kupca, max 50 znakova. Example: <code>"ACME Corp"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>contactLastName</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="contactLastName"                data-endpoint="POSTapi-customers"
               value=""Smith""
               data-component="body">
    <br>
<p>Prezime kontakt osobe, max 50 znakova. Example: <code>"Smith"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>contactFirstName</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="contactFirstName"                data-endpoint="POSTapi-customers"
               value=""John""
               data-component="body">
    <br>
<p>Ime kontakt osobe, max 50 znakova. Example: <code>"John"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Telefon, max 50 znakova. Example: <code>"123-456-7890"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>addressLine1</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="addressLine1"                data-endpoint="POSTapi-customers"
               value=""123 Elm St""
               data-component="body">
    <br>
<p>Adresa, max 50 znakova. Example: <code>"123 Elm St"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Grad, max 50 znakova. Example: <code>"Zagreb"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Država, max 50 znakova. Example: <code>"Croatia"</code></p>
        </div>
        </form>

                    <h2 id="customers-GETapi-customers--id-">Prikaz pojedinog kupca

Dohvaća detalje kupca prema ID-u (customerNumber).</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/customers/1001" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/customers/1001"
);
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID kupca. Example: <code>1001</code></p>
            </div>
                    </form>

                    <h2 id="customers-PUTapi-customers--id-">Ažuriranje kupca

Ažurira postojeće podatke kupca prema ID-u. Nisu svi podaci obavezni prilikom ažuriranja.</h2>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        &quot;customerName&quot;: [
            &quot;The customer name field is required when present.&quot;
        ]
    }
}</code>
 </pre>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="customerName"                data-endpoint="PUTapi-customers--id-"
               value=""ACME Updated""
               data-component="body">
    <br>
<p>Naziv kupca, max 50 znakova. Example: <code>"ACME Updated"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>contactLastName</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="contactLastName"                data-endpoint="PUTapi-customers--id-"
               value=""Smith""
               data-component="body">
    <br>
<p>Prezime kontakt osobe, max 50 znakova. Example: <code>"Smith"</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="contactFirstName"                data-endpoint="PUTapi-customers--id-"
               value=""John""
               data-component="body">
    <br>
<p>Ime kontakt osobe, max 50 znakova. Example: <code>"John"</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="addressLine1"                data-endpoint="PUTapi-customers--id-"
               value=""123 Elm St""
               data-component="body">
    <br>
<p>Adresa, max 50 znakova. Example: <code>"123 Elm St"</code></p>
...
<p>Država, max 50 znakova. Example: <code>"Croatia"</code></p>
                    ...
                    <h2 id="customers-DELETEapi-customers--id-">Brisanje kupca

Briše kupca iz baze prema ID-u.</h2>
...
Vraća JSON listu svih proizvoda iz baze.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="products-POSTapi-products">Spremi novi proizvod

Kreira novi proizvod sa zadanim podacima.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Naziv proizvoda. Example: <code>"Laptop"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Opis proizvoda. Example: <code>"Opis laptopa"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Cijena proizvoda. Example: <code>2500</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>ID kategorije kojoj proizvod pripada. Example: <code>2</code></p>
        </div>
        </form>

                    <h2 id="products-GETapi-products--id-">Prikaži proizvod po ID-u

Dohvaća detalje proizvoda prema ID-u.</h2>
...
<p>ID proizvoda. Example: <code>1</code></p>
                    ...
                    <h2 id="products-PUTapi-products--id-">Ažuriraj proizvod

Ažurira podatke proizvoda prema ID-u. Podaci nisu svi obavezni.</h2>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Naziv proizvoda, max 255 znakova. Example: <code>"Laptop Updated"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Opis proizvoda. Example: <code>"Novi opis"</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>price</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Cijena proizvoda, minimalno 0. Example: <code>2300</code></p>
        </div>
        </form>

                    <h2 id="products-DELETEapi-products--id-">Obriši proizvod

Briše proizvod iz baze prema ID-u.</h2>
